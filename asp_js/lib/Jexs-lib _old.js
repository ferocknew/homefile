...
//Js输出函数
Jexs.JS = function (words, RType) {
    if (RType == 1) {
        return "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><script>" + words + "</script>";
    } else {
        return "<script>" + words + "</script>";
    }
}
