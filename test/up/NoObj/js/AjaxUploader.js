...
AjaxProcesser.prototype.createUploader=function(){
	...
	button.value="上传";
	button.type="button";
	if(!this.defaultStyle){button.style.cssText="font-size:9pt;border:1px #dddddd solid;padding:3px 3px 1px 3px;height:20px;margin-top:3px;";}
	...
	add.value="添加文件";
	add.type="button";
	if(!_this.defaultStyle){add.style.cssText="font-size:9pt;border:1px #dddddd solid;padding:3px 3px 1px 3px;height:20px;margin-top:3px;margin-left:3px;";}
	...
	processDiv.style.cssText="display:none;padding:3px;font-size:9pt;border:1px #eeeeee solid;width:406px;margin:5px 2px 2px 0px;";
