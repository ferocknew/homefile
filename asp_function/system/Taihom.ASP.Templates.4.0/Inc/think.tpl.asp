...
'2011.04.04 今天是我生日~~ 修复了 缓存方式是 3,4时候不生效的BUG，还修复了其他一些小BUG

'2011.03.12 修复块标签记录集赋值无效 by 智者千虑

'2011.03.10 , 依照 智者千虑  liaoyizhi@gmail.com(QQ89053889) BUG反馈修复
'1、修复 IF 的BUG
'2、增加单标签赋值的字典赋值叠加功能


Class Taihom_tpl
'Think ASP Template(Taihom)
'版本 4.0 2011/1/16
