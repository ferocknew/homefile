...
_143.find("div.datagrid-cell").resizabled({handles:"e",minWidth:50,onStartResize:function(e){
...
$("div.datagrid-view1 div.datagrid-header div.datagrid-cell",_13d).resizabled({onStopResize:function(e){
_14b(_13c,this);
...
var t=$(this);
var opts=$.extend({},$.fn.dialog.defaults,{title:(t.attr("title")?t.attr("title"):undefined),href:t.attr("href"),collapsible:(t.attr("collapsible")?t.attr("collapsible")=="true":undefined),minimizable:(t.attr("minimizable")?t.attr("minimizable")=="true":undefined),maximizable:(t.attr("maximizable")?t.attr("maximizable")=="true":undefined),resizabled:(t.attr("resizabled")?t.attr("resizabled")=="true":undefined)},_267);
$.data(this,"dialog",{options:opts,contentPanel:_258(this)});
}
_25b(this);
});
};
$.fn.dialog.defaults={title:"New Dialog",href:null,collapsible:false,minimizable:false,maximizable:false,resizabled:false,toolbar:null,buttons:null};
})(jQuery);
(function($){
function drag(e){
var opts=$.data(e.data.target,"draggabled").options;
var _26a=e.data;
...
function _26b(e){
var opts=$.data(e.data.target,"draggabled").options;
var _26c=$.data(e.data.target,"draggabled").proxy;
if(_26c){
_26c.css("cursor",opts.cursor);
}else{
_26c=$(e.data.target);
$.data(e.data.target,"draggabled").handle.css("cursor",opts.cursor);
}
...
$.data(e.data.target,"draggabled").droppables=_26e;
var _270=$.data(e.data.target,"draggabled").proxy;
if(!_270){
if(opts.proxy){
if(opts.proxy=="clone"){
...
$.data(e.data.target,"draggabled").proxy=_270;
}else{
_270=$(e.data.target);
}
}
...
function _271(e){
drag(e);
if($.data(e.data.target,"draggabled").options.onDrag.call(e.data.target,e)!=false){
_26b(e);
}
var _272=e.data.target;
$.data(e.data.target,"draggabled").droppables.each(function(){
var _273=$(this);
var p2=$(this).offset();
...
function doUp(e){
drag(e);
var _274=$.data(e.data.target,"draggabled").proxy;
var opts=$.data(e.data.target,"draggabled").options;
if(opts.revert){
if(_275()==true){
_276();
...
$.data(e.data.target,"draggabled").proxy=null;
};
function _275(){
var _277=false;
$.data(e.data.target,"draggabled").droppables.each(function(){
...
$(document).unbind(".draggabled");
return false;
};
$.fn.draggabled=function(_279){
if(typeof _279=="string"){
switch(_279){
case "options":
return $.data(this[0],"draggabled").options;
case "proxy":
return $.data(this[0],"draggabled").proxy;
case "enable":
return this.each(function(){
$(this).draggabled({disabled:false});
});
case "disable":
return this.each(function(){
$(this).draggabled({disabled:true});
});
}
}
return this.each(function(){
var opts;
var _27a=$.data(this,"draggabled");
if(_27a){
_27a.handle.unbind(".draggabled");
opts=$.extend(_27a.options,_279);
}else{
opts=$.extend({},$.fn.draggabled.defaults,_279||{});
}
...
$.data(this,"draggabled",{options:opts,handle:_27b});
_27b.bind("mousedown.draggabled",{target:this},_27c);
_27b.bind("mousemove.draggabled",{target:this},_27d);
function _27c(e){
if(_27e(e)==false){
return;
}
...
$(document).bind("mousedown.draggabled",data,_26d);
$(document).bind("mousemove.draggabled",data,_271);
$(document).bind("mouseup.draggabled",data,doUp);
};
function _27d(e){
if(_27e(e)){
...
$.fn.draggabled.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onStartDrag:function(e){
},onDrag:function(e){
...
_2ae.resizabled({handles:_2af,onStartResize:function(e){
_2a2=true;
...
win.window({title:_2eb,width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizabled:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggabled:false,resizabled:false,closed:true,onBeforeOpen:function(){
...
(function($){
$.fn.resizabled=function(_364){
function _365(e){
var _366=e.data;
var _367=$.data(_366.target,"resizabled").options;
...
function _36d(e){
$.data(e.data.target,"resizabled").options.onStartResize.call(e.data.target,e);
return false;
};
function _36e(e){
_365(e);
if($.data(e.data.target,"resizabled").options.onResize.call(e.data.target,e)!=false){
_36a(e);
}
return false;
};
...
_365(e,true);
_36a(e);
$(document).unbind(".resizabled");
$.data(e.data.target,"resizabled").options.onStopResize.call(e.data.target,e);
return false;
};
return this.each(function(){
var opts=null;
var _36f=$.data(this,"resizabled");
if(_36f){
$(this).unbind(".resizabled");
opts=$.extend(_36f.options,_364||{});
}else{
opts=$.extend({},$.fn.resizabled.defaults,_364||{});
}
if(opts.disabled==true){
return;
}
$.data(this,"resizabled",{options:opts});
var _370=this;
$(this).bind("mousemove.resizabled",_371).bind("mousedown.resizabled",_372);
function _371(e){
var dir=_373(e);
if(dir==""){
...
$(document).bind("mousedown.resizabled",data,_36d);
$(document).bind("mousemove.resizabled",data,_36e);
$(document).bind("mouseup.resizabled",data,doUp);
};
function _373(e){
var dir="";
...
$.fn.resizabled.defaults={disabled:false,handles:"n, e, s, w, ne, se, sw, nw, all",minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000,edge:5,onStartResize:function(e){
},onResize:function(e){
},onStopResize:function(e){
}};
})(jQuery);
...
_463.window.draggabled({handle:">div.panel-header>div.panel-title",disabled:_463.options.draggabled==false,onStartDrag:function(e){
if(_463.mask){
...
_463.window.resizabled({disabled:_463.options.resizabled==false,onStartResize:function(e){
if(!_463.proxy){
_463.proxy=$("<div class=\"window-proxy\"></div>").insertAfter(_463.window);
}
...
$.fn.window.defaults={zIndex:9000,draggabled:true,resizabled:true,shadow:true,modal:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false};
})(jQuery);
